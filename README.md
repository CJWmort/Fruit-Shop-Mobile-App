# Fruit Shop Mobile App (YayaPapaya)

Side project, learning flutter and Dart language to develop a fruit shop mobile application.
...
The app is used to order fruits online from the yayapapaya fruit shop, a Shopping Cart Application (CRUD Features).
